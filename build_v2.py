...
CHAPTER_GROUPS = [
    (0,  "36块=1000钻？"),         # s00 + s01
    (2,  "官方价 vs 我们的价"),     # s02 + s03
    (4,  "某鱼代充能不能碰"),       # s04
    (5,  "为什么要买CS2箱子"),      # s05
    (6,  "账号·区服·防找回"),       # s06 + s07 + s08
    (9,  "算时间差·22天到手"),      # s09 + s10
    (11, "选热潮箱·配BUFF"),        # s11 + s12
    (13, "倒余额·两条路线"),        # s13 + s14 + s14b
    (16, "防钓鱼·卖出换钻"),        # s15 + s16
    (18, "亲测成绩单·22天"),        # s17 + s18
    (20, "钻会过期·尾声"),          # s19 + s20 + s21
]
